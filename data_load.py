...
class DataLoader:
    ...
    def __init__(self, dataset_type, settings = None):
    ...
    def load_data(self, reload=False):
        ...
        ready_file_path =  "datasets\\ready\\" + self.__dataset_name + settings_str + ".npy"
        ...
        if(self.__dataset_type == Dataset.YALE_EX_CROPPED or self.__dataset_type == Dataset.YALE_EX):
            ...
            self.__landmark_detector.loadModel('models/lbfmodel.yaml')
